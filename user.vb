...
Public Class Motor
    Private Sub btnSV_Click(sender As Object, e As EventArgs) Handles btnSV.Click
        ...
        sql()
        Dim cmd As New MySqlCommand("INSERT INTO parkings (transaction_id, plate_number, type_id, has_paid, time_in, date) " & "VALUES (@transaction_id, @plate, 1, 0, @time_in, @date_in)", conn)
